...
import StyledPegaUidTimeOfDayWrapper from './styles';
...
const PegaUidTimeOfDay = props => {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return ( <StyledPegaUidTimeOfDayWrapper> displayComp </StyledPegaUidTimeOfDayWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledPegaUidTimeOfDayWrapper>
          <FieldValueList
