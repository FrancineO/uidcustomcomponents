...
import StyledPegaUidPageCaseWidgetWrapper from './styles';
...
export default function PegaUidPageCaseWidget(props) {
  ...
  return user.userId && user.userName ? (
    <StyledPegaUidPageCaseWidgetWrapper>
      <Card>
...
PegaUidPageCaseWidget.defaultProps = {
  "label": "Create operator",
...
PegaUidPageCaseWidget.propTypes = {
