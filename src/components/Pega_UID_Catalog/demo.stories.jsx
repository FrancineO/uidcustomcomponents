...
import PegaUidCatalog from './index.jsx';
import { pyHome1Resolved, pyHome1Raw } from './mock.stories.js';

export default {
  title: 'PegaUidCatalog',
  decorators: [withKnobs],
  component: PegaUidCatalog
};

export const basePegaUidCatalog = () => {
  if (!window.PCore) {
    window.PCore = {};
  }
  ...
  return (
    <>
      <PegaUidCatalog {...props}>{regionAChildren}</PegaUidCatalog>
    </>
  );
};
