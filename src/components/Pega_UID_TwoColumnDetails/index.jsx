...
import StyledPegaUidTwoColumnDetailsWrapper from './styles';
...
export default function PegaUidTwoColumnDetails(props) {
  ...
  return (
    <StyledPegaUidTwoColumnDetailsWrapper>
...
PegaUidTwoColumnDetails.defaultProps = {
  label: undefined,
  showLabel: true,
...
PegaUidTwoColumnDetails.propTypes = {
