...
import PegaUidTwoColumnDetails from './index';
...
export default {
  title: 'PegaUidTwoColumnDetails',
  component: PegaUidTwoColumnDetails
};
...
export const basePegaUidTwoColumnDetails = () => {
  const props = {
  ...
  return (
    <PegaUidTwoColumnDetails {...props}>
      {regionAChildren}
      {regionBChildren}
    </PegaUidTwoColumnDetails>
  );
};
