...
import StyledPegaUidCaseWidgetWrapper from './styles';
...
export default function PegaUidCaseWidget(props) {
  ...
  return (
    <StyledPegaUidCaseWidgetWrapper>
    <Table
...
PegaUidCaseWidget.defaultProps = {

};

PegaUidCaseWidget.propTypes = {
