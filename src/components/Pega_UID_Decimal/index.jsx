...
// includes in bundle
import StyledPegaUidDecimalWrapper from './styles';
...
const PegaUidDecimal = props => {
  ...
  if (['DISPLAY_ONLY', 'LABELS_LEFT', 'STACKED_LARGE_VAL'].includes(displayMode)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledPegaUidDecimalWrapper> displayComp </StyledPegaUidDecimalWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledPegaUidDecimalWrapper>
          <FieldValueList
