...
import StyledPegaUidDateTimeWrapper from './styles';

// Duplicated runtime code from Constellation Design System Component

// props passed in combination of props from property panel (config.json) and run time props from Constellation
// any default values in config.pros should be set in defaultProps at bottom of this file
const PegaUidDateTime = props => {
  const {
    getPConnect,
    value,
    validatemessage,
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return ( <StyledPegaUidDateTimeWrapper> displayComp </StyledPegaUidDateTimeWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledPegaUidDateTimeWrapper>
          <FieldValueList
