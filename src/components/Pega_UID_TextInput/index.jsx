...
import StyledPegaUidTextInputWrapper from './styles';
 ...
 const {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPegaUidTextInputWrapper> displayComp </StyledPegaUidTextInputWrapper>
    ) : (
      <StyledPegaUidTextInputWrapper>
      <FieldValueList
