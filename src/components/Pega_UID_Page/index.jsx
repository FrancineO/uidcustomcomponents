...
import StyledPegaUidPageWrapper from './styles';
...
export default function PegaUidPage(props) {
...
PegaUidPage.defaultProps = {
  /* icon: '', */
  useConfigurableLayout: false
};

PegaUidPage.propTypes = {
