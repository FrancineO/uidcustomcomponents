...
import StyledPegaUidCurrencyWrapper from './styles';
...
const PegaUidCurrency = props => {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledPegaUidCurrencyWrapper> displayComp </StyledPegaUidCurrencyWrapper>) ;
      }
      case 'LABELS_LEFT': {
        return (
          <StyledPegaUidCurrencyWrapper>
          <FieldValueList
