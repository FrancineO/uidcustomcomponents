...
import PegaUidDetails from './index';
...
export default {
  title: 'PegaUidDetails',
  component: PegaUidDetails
};
...
export const basePegaUidDetails = () => {
  const props = {
  ...
  return (
    <>
      <PegaUidDetails {...props}>{regionAChildren}</PegaUidDetails>
    </>
  );
};
