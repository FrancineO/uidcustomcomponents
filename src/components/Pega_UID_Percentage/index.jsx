...
import StyledPegaUidPercentageWrapper from './styles';
...
const PegaUidPercentage = props => {
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'DISPLAY_ONLY') {
    ...
    return displayMode === 'DISPLAY_ONLY' ? (
      <StyledPegaUidPercentageWrapper>
      displayComp
      </StyledPegaUidPercentageWrapper>
    ) : (
      <StyledPegaUidPercentageWrapper>
...
PegaUidPercentage.defaultProps = {
  value: '',
  placeholder: '',
  validatemessage: '',
  helperText: '',
