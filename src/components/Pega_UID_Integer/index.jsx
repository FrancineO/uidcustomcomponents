...
import StyledPegaUidIntegerWrapper from './styles';
...
const PegaUidInteger = props => {
  ...
  if (['LABELS_LEFT', 'STACKED_LARGE_VAL', 'DISPLAY_ONLY'].includes(displayMode)) {
    ...
    switch (displayMode) {
      case 'DISPLAY_ONLY': {
        return (<StyledPegaUidIntegerWrapper> displayComp </StyledPegaUidIntegerWrapper>);
      }
      case 'LABELS_LEFT': {
        return (
          <StyledPegaUidIntegerWrapper>
          <FieldValueList
