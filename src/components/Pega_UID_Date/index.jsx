...
import StyledPegaUidDateWrapper from './styles';
...
const PegaUidDate = props => {
 ...
 let { readOnly, required, disabled } = props;
  ...
  if (displayMode === 'LABELS_LEFT' || displayMode === 'STACKED_LARGE_VAL' || displayMode === 'DISPLAY_ONLY') {
    ...
    switch(displayMode){
      case 'DISPLAY_ONLY': {
        return ( <StyledPegaUidDateWrapper> displayComp </StyledPegaUidDateWrapper>);
      }
      case "LABELS_LEFT" : {
        return (
          <StyledPegaUidDateWrapper>
          <FieldValueList
